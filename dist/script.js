...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.accordion = function (headActive = 'acccordion-head--active', contentActive = 'accordion-content--active', paddings = 40) {
...
/***/ "./src/js/lib/components/services/requests.js":
/*!****************************************************!*\
  !*** ./src/js/lib/components/services/requests.js ***!
  \****************************************************/
/*! no exports provided */
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).prototype.get = async function (url, dataTypeAnswer = 'json') {
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../core'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).prototype.post = async function (url, data, dataTypeAnswer = 'text') {
  let res = await fetch(url, {
    method: "POST",
    body: data
  });
...
/* harmony import */ var _components_services_requests__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/services/requests */ "./src/js/lib/components/services/requests.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function () {
  let counter = 0;
